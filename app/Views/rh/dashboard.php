...
echo view('layout/main', [
    ...
    'content' => '
        ...
        <div style="text-align: center; padding: 2rem;"><i class="bi bi-graph-up" style="font-size: 3rem; color: var(--muted); opacity: 0.3;"></i><p style="color: var(--muted); margin-top: 1rem;">Dashboard RH — À développer</p></div>
    ',
]);
