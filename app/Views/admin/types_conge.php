...
echo view('layout/main', [
    ...
    ',
    'topbar_actions' => '',
    'content' => '<div style="text-align: center; padding: 2rem;"><i class="bi bi-tags" style="font-size: 3rem; color: var(--muted); opacity: 0.3;"></i><p style="color: var(--muted); margin-top: 1rem;">Gestion des types de congé — À développer</p></div>',
]);
