...
<body>
    <?php
    $user_nom = $user_nom ?? 'Administrateur';
    $user_role = $user_role ?? 'Admin système';
    $page = $page ?? 'dashboard';
    ...
    <div class="app-wrap">
        ...
        <aside class="sidebar">
            <div class="sidebar-brand">
                ...
                <div class="sidebar-brand-name">TechMada Admin<span>Panel Admin</span></div>
            </div>
            
            <div class="sidebar-section">Administration</div>
            <ul class="sidebar-nav">
                <li>
                    <a href="<?= route_to('admin_dashboard') ?>" class="<?= $page === 'dashboard' ? 'active' : '' ?>">
                        <i class="bi bi-speedometer2"></i> Tableau de bord
                    </a>
                </li>
                <li>
                    <a href="<?= route_to('admin_employes') ?>" class="<?= $page === 'employes' ? 'active' : '' ?>">
                        <i class="bi bi-people"></i> Employés
                    </a>
                </li>
                <li>
                    <a href="<?= route_to('admin_demandes_all') ?>" class="<?= $page === 'demandes' ? 'active' : '' ?>">
                        <i class="bi bi-file-text"></i> Demandes
                        <?php if ($pending_count > 0): ?>
                        <span class="nav-badge alert"><?= $pending_count ?></span>
                        <?php endif; ?>
                    </a>
                </li>
            </ul>
            ...
            <ul class="sidebar-nav">
                <li>
                    <a href="<?= route_to('admin_departements') ?>" class="<?= $page === 'departements' ? 'active' : '' ?>">
                        <i class="bi bi-building"></i> Départements
                    </a>
                </li>
                <li>
                    <a href="<?= route_to('admin_types_conge') ?>" class="<?= $page === 'types_conge' ? 'active' : '' ?>">
                        <i class="bi bi-calendar-check"></i> Types de congé
                    </a>
                </li>
            </ul>
            ...
            <div class="sidebar-user">
                <div class="s-user-row">
                    <div class="avatar av-green"><?= substr($user_nom, 0, 2) ?></div>
                    <div>
                        <div class="user-name"><?= $user_nom ?></div>
                        <div class="user-role"><?= $user_role ?></div>
                    </div>
                    <a href="<?= route_to('auth_logout') ?>" style="margin-left:auto;color:rgba(255,255,255,.25);font-size:1.1rem" title="Déconnexion"><i class="bi bi-box-arrow-right"></i></a>
                </div>
            </div>
        </aside>
        ...
        <div class="main">
            ...
            <div class="topbar">
                <div>
                    ...
                    <div class="topbar-breadcrumb">Accueil / <?= ucfirst($page) ?></div>
                </div>
                <div class="topbar-actions">
                    <a href="<?= route_to('admin_dashboard') ?>" class="icon-btn" title="Rafraîchir"><i class="bi bi-arrow-clockwise"></i></a>
                </div>
            </div>
            ...
            <!-- FOOTER -->
            <div class="footer-app"><i class="bi bi-c-circle"></i> 2025 <span>TechMada RH</span> — Panel Admin</div>
        </div>
    </div>
</body>
</html>
