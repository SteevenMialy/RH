        ...
        <div class="auth-split">
            ...
            <div class="auth-left">
                ...
                <div class="auth-roles">
                    ...
                    <div class="role-pill">
                        <i class="bi bi-person"></i>
                        <div><div class="role-pill-name">Employé IT</div><div class="role-pill-cred">jean.dupont@techmada.mg · emp123</div></div>
                    </div>
                    <div class="role-pill">
                        <i class="bi bi-person"></i>
                        <div><div class="role-pill-name">Employé Finance</div><div class="role-pill-cred">marie.martin@techmada.mg · emp123</div></div>
                    </div>
                </div>
            </div>
